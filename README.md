...
```bash
npm install @ardhitaoffc/baileys-pro
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @ardhitaoffc/baileys-pro@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@ardhitaoffc/baileys-pro")
```
...
```javascript
const makeWASocket = require("@ardhitaoffc/baileys-pro").default;
const { useMultiFileAuthState } = require("@ardhitaoffc/baileys-pro");
...
```javascript
const makeWASocket = require("@ardhitaoffc/baileys-pro").default;
const { DisconnectReason, useMultiFileAuthState } = require("@ardhitaoffc/baileys-pro");
...
```javascript
const makeWASocket = require("@ardhitaoffc/baileys-pro").default;
const { makeInMemoryStore } = require("@ardhitaoffc/baileys-pro");
...
const { downloadMediaMessage, getContentType } = require("@ardhitaoffc/baileys-pro");
